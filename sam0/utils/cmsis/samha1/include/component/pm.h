...
#define PM_AHBMASK_MASK             _U(0x0000003F) /**< \brief (PM_AHBMASK) MASK Register */
...
#define PM_APBBMASK_MASK            _U(0x0000005F) /**< \brief (PM_APBBMASK) MASK Register */
...
#define PM_APBCMASK_LINCTRL         (_U(0x1) << PM_APBCMASK_LINCTRL_Pos)
#define PM_APBCMASK_MASK            _U(0x004FFFFF) /**< \brief (PM_APBCMASK) MASK Register */
